...
CI (`.github/workflows/ci.yml`) runs three checks on every push and PR: `gdlint`, `gdformat --check`, and the gdUnit4 test suite. Running them locally first means green locally ≈ green in CI.
